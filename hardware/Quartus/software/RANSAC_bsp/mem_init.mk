...
$(MEM_1)_HIERARCHICAL_PATH := memoria_dados
$(MEM_1)_WIDTH := 32
...
.PHONY: memoria_dados
memoria_dados: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

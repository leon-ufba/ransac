add wave -noupdate -divider {RANSAC_NIOS_Processador: top-level ports}
...
add wave -noupdate -divider {RANSAC_NIOS_Processador: common}
...
add wave -noupdate -divider {RANSAC_NIOS_Processador: breaks}

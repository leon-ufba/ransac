...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/verbosity_pkg.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0_rsp_mux_001.sv \
  ...
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_avalon_sc_fifo.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_slave_agent.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_master_agent.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_slave_translator.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_master_translator.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_irq_mapper.sv \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_memoria_dados.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_memoria.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_jtag.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_Processador.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_Processador_jtag_debug_module_sysclk.v \
  $QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_Processador_jtag_debug_module_tck.v \

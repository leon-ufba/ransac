...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                           -cdslib ./cds_libs/cmd_mux_001.cds.lib                          
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                        -work cmd_mux_001                           -cdslib ./cds_libs/cmd_mux_001.cds.lib                          
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/RANSAC_NIOS_mm_interconnect_0_router_003.sv"                        -work router_003                            -cdslib ./cds_libs/router_003.cds.lib                           
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                            -work jtag_avalon_jtag_slave_agent_rsp_fifo -cdslib ./cds_libs/jtag_avalon_jtag_slave_agent_rsp_fifo.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_slave_agent.sv"                                       -work jtag_avalon_jtag_slave_agent          -cdslib ./cds_libs/jtag_avalon_jtag_slave_agent.cds.lib         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                                -work jtag_avalon_jtag_slave_agent          -cdslib ./cds_libs/jtag_avalon_jtag_slave_agent.cds.lib         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RANSAC_NIOS_tb/simulation/submodules/altera_merlin_slave_translator.sv"                                  -work jtag_avalon_jtag_slave_translator     -cdslib ./cds_libs/jtag_avalon_jtag_slave_translator.cds.lib    

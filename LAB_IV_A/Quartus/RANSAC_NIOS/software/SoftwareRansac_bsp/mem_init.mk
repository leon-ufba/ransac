...
# Memory: MemoriaDados
MEM_0 := SistemaEmbarcado_MemoriaDados
$(MEM_0)_NAME := MemoriaDados
...
$(MEM_0)_HIERARCHICAL_PATH := MemoriaDados
$(MEM_0)_WIDTH := 32
...
.PHONY: MemoriaDados
MemoriaDados: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: MemoriaPrograma
MEM_1 := SistemaEmbarcado_MemoriaPrograma
$(MEM_1)_NAME := MemoriaPrograma
...
$(MEM_1)_END := 0x0005c3bf
$(MEM_1)_SPAN := 0x0001c3c0
$(MEM_1)_HIERARCHICAL_PATH := MemoriaPrograma
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: MemoriaPrograma
MemoriaPrograma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
